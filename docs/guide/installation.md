...
```bash
curl -fsSL https://raw.githubusercontent.com/darkLordIceCream/learn-anything-with-AI/main/docs/guide/installation.md
```
...
# 2. 下载核心文件
BASE="https://raw.githubusercontent.com/darkLordIceCream/learn-anything-with-AI/main/skills/learn-anything-skill"
...
下一步需要：
1. **重启 OpenCode**（skill 只在启动时加载，不热重载）
...
如果用户更希望 clone 整个仓库（便于更新和修改）：

```bash
git clone https://github.com/darkLordIceCream/learn-anything-with-AI.git /tmp/learn-anything-skill-install
